...
return [
    ...
    'login.err.locked_out'      => ['en' => 'Too many failed login attempts. Please try again in a few minutes.', 'so' => 'Waxaa jiray isku day badan oo fashilmay. Fadlan isku day mar kale dhowr daqiiqo kadib.'],

    // Login page — Forgot Password / reset flow (modules/auth/login.php only)
    'login.forgot_link'          => ['en' => 'Forgot Password?', 'so' => 'Ma illowday furahaaga sirta ah?'],
    'login.reset.title'          => ['en' => 'Forgot Password?', 'so' => 'Ma illowday furahaaga sirta ah?'],
    'login.reset.email_intro'    => ['en' => 'Enter your registered email address and we\'ll send you a verification code.', 'so' => 'Geli iimaylkaaga diiwaan gashan, waxaan kuu soo dirinaa koodh xaqiijin ah.'],
    'login.reset.email_label'    => ['en' => 'Email Address', 'so' => 'Ciwaanka Iimaylka'],
    'login.reset.send_code'      => ['en' => 'Send Verification Code', 'so' => 'Dir Koodhka Xaqiijinta'],
    'login.reset.back_to_login'  => ['en' => 'Back to Login', 'so' => 'Ku Noqo Gelitaanka'],
    'login.reset.otp_title'      => ['en' => 'Verification Code', 'so' => 'Koodhka Xaqiijinta'],
    'login.reset.otp_intro'      => ['en' => 'We sent a verification code to', 'so' => 'Koodh xaqiijin ayaan u dirnay'],
    'login.reset.otp_label'      => ['en' => '6-Digit Code', 'so' => 'Koodhka 6-tirooyinka ah'],
    'login.reset.verify_code'    => ['en' => 'Verify Code', 'so' => 'Xaqiiji Koodhka'],
    'login.reset.resend_code'    => ['en' => 'Resend Code', 'so' => 'Dib u Dir Koodhka'],
    'login.reset.new_password_title' => ['en' => 'Create New Password', 'so' => 'Samee Furaha Sirta ah ee Cusub'],
    'login.reset.new_password_label' => ['en' => 'New Password', 'so' => 'Furaha Sirta ah ee Cusub'],
    'login.reset.confirm_password_label' => ['en' => 'Confirm Password', 'so' => 'Xaqiiji Furaha Sirta ah'],
    'login.reset.submit_new_password' => ['en' => 'Reset Password', 'so' => 'Dib u Deji Furaha Sirta ah'],
    'login.reset.success_title'  => ['en' => 'Password Reset Complete', 'so' => 'Dib u Dejinta Furaha Waa Dhammaatay'],
    'login.reset.success_message' => ['en' => 'Your password has been reset successfully.', 'so' => 'Furahaaga sirta ah si guul leh ayaa dib loo deji yay.'],
    'login.reset.err.invalid_email' => ['en' => 'Enter a valid email address.', 'so' => 'Geli ciwaan iimayl oo sax ah.'],
    'login.reset.generic_sent'   => ['en' => 'If that email is registered, a verification code is on its way.', 'so' => 'Haddii iimaylkaasi diiwaan gashan yahay, koodh xaqiijin ayaa kuu socda.'],
    'login.reset.err.otp_required' => ['en' => 'Enter the 6-digit code.', 'so' => 'Geli koodhka 6-tirooyinka ah.'],
    'login.reset.err.otp_invalid' => ['en' => 'Invalid verification code.', 'so' => 'Koodhka xaqiijinta waa khalad.'],
    'login.reset.err.otp_expired' => ['en' => 'This code has expired. Request a new one below.', 'so' => 'Koodhkani wuu dhacay. Hoos ka codso mid cusub.'],
    'login.reset.err.otp_used'   => ['en' => 'This code has already been used. Request a new one below.', 'so' => 'Koodhkani horey ayaa loo isticmaalay. Hoos ka codso mid cusub.'],
    'login.reset.err.otp_locked' => ['en' => 'Too many incorrect attempts. Request a new code below.', 'so' => 'Isku day badan oo khalad ah. Hoos ka codso koodh cusub.'],
    'login.reset.err.session'    => ['en' => 'Your reset session expired. Please start again.', 'so' => 'Fadhigaaga dib-u-dejinta wuu dhacay. Fadlan mar kale bilow.'],
    'login.reset.err.password_length' => ['en' => 'Password must be at least 6 characters.', 'so' => 'Furaha sirta ah waa inuu ugu yaraan ahaadaa 6 xaraf.'],
    'login.reset.err.password_mismatch' => ['en' => 'New password and confirmation do not match.', 'so' => 'Furaha cusub iyo xaqiijintiisu isku mid ma aha.'],
    'login.reset.err.send_failed' => ['en' => 'We could not send the email right now. Please try again shortly.', 'so' => 'Ma awoodin inaan iimaylka dirno hadda. Fadlan mar kale isku day.'],
